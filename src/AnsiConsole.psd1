...
GUID = 'ceaa2866-fbe6-4c33-a30a-92900b050075'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        # LicenseUri = 'https://github.com/kenmuse/AnsiConsole/blob/main/LICeNSE'

        # A URL to the main website for this project.
        # ProjectUri = 'https://github.com/kenmuse/AnsiConsole'
